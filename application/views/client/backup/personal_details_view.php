        ...
        <div class="col-12">
            <div class="card wizard-content">
                <div class="card-body">
                    ...
                    <?= validation_errors(); ?>
                    <h6 class="card-subtitle">Complete the personal details form below</h6>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="fileinput fileinput-new input-group" data-provides="fileinput">
													<div class="form-control" data-trigger="fileinput"> <i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div> <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
													<input type="hidden">
													<input type="hidden"><input type="file" name="pda_file[]" id="pda_file[]"> </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> </div>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<input type="button" value="+ Add more previous degrees" id="add_pd" />
									<input type="button" value="- Remove previous degrees" id="rem_pd" />
								</div>
							</div>
							<?php endif; ?>
                            <div class="row">
