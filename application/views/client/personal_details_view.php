...
<html lang="en">
    ...
    <head>
        ...
        <title>Bayelsa State Loan Management System</title>
        <!-- CSS -->
        <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:400,100,300,500">
        <link rel="stylesheet" href="<?=base_url()?>assets/clients/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/clients/font-awesome/css/font-awesome.min.css">
		    <link rel="stylesheet" href="<?=base_url()?>assets/clients/css/form-elements.css">
        <link rel="stylesheet" href="<?=base_url()?>assets/clients/css/style.css">
    </head>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-1 text">
                        <img src="<?=base_url()?>/assets/clients/img/logo.png"/>
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-9 col-lg-offset-1 form-box">
                    	<form role="form" action="<?=base_url('client/PersonalDetails')?>" enctype="multipart/form-data" method="post" class="f1">

                    		<p style="float:right;"><a href="login/logout">Logout</a></p>
                    		<p>Welcome <?=$this->session->firstname.' '.$this->session->lastname?>, complete the form below.</p>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <input type="file" class="form-control-file" id="dob_file" name="dob_file">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <input type="file" class="form-control-file" id="lga_file" name="lga_file">
                                              <!--<div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                  <div class="form-control" data-trigger="fileinput">
                                                      <i class="fa fa-file fileinput-exists"></i>
                                                      <span class="fileinput-filename"></span>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label>Upload Identification</label>
                                            <input type="file" class="form-control-file" id="mid_file" name="mid_file">
                                        <!--  <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <input type="file" class="form-control-file" id="ref_file" name="ref_file">
                    ...
                    <?php if($details['loan_type'] == 'Health' || $details['loan_type'] == 'Law'): ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control-file" id="pda_file[]" name="pda_file[]">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <input type="button" value="- Remove previous degrees" id="rem_pd" style=" font-size: small; margin-left: 30px; "/>
                      </div>
                    </div>
                    <?php endif; ?>
                                  <div class="row">
        ...
        <!-- Javascript -->
        <script src="<?=base_url()?>assets/clients/js/jquery-1.11.1.min.js"></script>
        <script src="<?=base_url()?>assets/clients/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?=base_url()?>assets/clients/js/jquery.backstretch.min.js"></script>
        <script src="<?=base_url()?>assets/clients/js/retina-1.1.0.min.js"></script>
        <script src="<?=base_url()?>assets/clients/js/scripts.js"></script>
