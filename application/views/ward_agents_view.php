		...
		<div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
					...
					<form class="forms-sample" method="post" action="<?=base_url('agents/viewWardAgents');?>">
					<p>
					...
					<input type="submit" name="get_ward_agents" value="Get Agent" class="btn btn-success mr-2 btn-block"/>
					</form>
				</div>
			</div>
		</div>
							...
							<tbody>
								...
								if(isset($agents) && !empty($agents)):
									foreach($agents as $a):
										...
										echo "<td>".$a['district_name']."</td>";
										echo "<td>".$a['state_id'].'/'.$a['lga_id'].'/'.$a['ward_id']."</td>";
										echo "<td>".$a['agent1']."</td>";
										echo "<td>".$a['phone1']."</td>";
