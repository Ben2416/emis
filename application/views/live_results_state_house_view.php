              ...
              <div class="card">
				...
				<p>
					...
					<div class="row" style="font-size:12px;">
						...
						<div class="col-md-6">
							<select name="state_constituent" id="state_constituent">
								<?php foreach($state_constituents as $c): 
									echo "<option value='".$c['state_constituent_id']."'>".$c['state_constituent_name']."</option>";
									endforeach;
								?>
							</select>
